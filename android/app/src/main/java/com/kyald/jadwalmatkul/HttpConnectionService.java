 ...
 */
public class HttpConnectionService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.matkul_list);
    ...
    private class ServiceStubAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            HttpURLConnection service = new HttpConnectionService();
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final HttpConnectionService mParentActivity;
        ...
        SimpleItemRecyclerViewAdapter(HttpConnectionService parent,
