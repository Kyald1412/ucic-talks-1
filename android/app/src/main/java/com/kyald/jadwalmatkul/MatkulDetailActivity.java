...
/**
 * An activity representing a single Matkul detail screen. This
...
public class MatkulDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(MatkulDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(MatkulDetailFragment.ARG_ITEM_ID));
            MatkulDetailFragment fragment = new MatkulDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.matkul_detail_container, fragment)
                    .commit();
        }
    }
